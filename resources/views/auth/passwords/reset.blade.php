...
<html lang="en">
  <head>
    ...
    <!-- Base Stylesheet -->
    <link href="/css/vertical-layout-light/output.css" rel="stylesheet" />
      ...
      <div class="hidden md:flex md:w-1/2 bg-gradient-to-br from-emerald-700 to-emerald-900 text-white relative overflow-hidden">
        ...
        <div class="w-full h-full flex flex-col justify-between relative z-10 p-8 lg:p-12">
          ...
          <div class="flex items-center">
            <img src="/assets/LOGO-ISI-JADI-FINAL.png" alt="Desa Kedungwungu" class="w-16 h-16 object-contain rounded-full bg-white p-1" />
            <div class="ml-4">
          ...
          <div class="flex-grow flex flex-col justify-center py-4">
            ...
            <p class="text-emerald-50 mb-4">Akses informasi dan layanan helpdesk kapan saja dan di mana saja</p>

            <!-- Featured Image - Desktop Only -->
            <div class="w-full mx-auto rounded-xl overflow-hidden shadow-lg">
              <img src="/assets/rektorat.jpg" alt="Helpdesk Ticketing" class="w-full h-auto object-cover" />
            </div>
          </div>
            ...
            <div class="mb-8 relative">
              ...
              <div class="relative">
                ...
                <p class="text-gray-600 mt-2 flex items-center">
                  ...
                  Buat akun untuk mengakses layanan helpdesk
                </p>
              </div>
            </div>
