...
<body class="font-sans text-gray-900 antialiased">
    ...
    <div class="min-h-screen flex flex-col md:flex-row">
        ...
        <div
            class="hidden md:flex md:w-1/2 bg-gradient-to-br from-emerald-700 to-emerald-900 text-white relative overflow-hidden">
            <div class="absolute inset-0 bg-pattern opacity-10"></div>
            <div class="w-full h-full flex flex-col justify-between relative z-10 p-8 lg:p-12">
                <!-- Top Area -->
                <div class="flex items-center">
                    <img src="/images/LOGO-ISI-JADI-FINAL.png" alt="logo-isi"
            ...
            <div class="w-full max-w-md min-h-screen md:min-h-0 flex flex-col justify-between py-6">
                ...
                <div class="md:hidden">
                    ...
                    <div class="flex items-start justify-start sm:items-center sm:justify-center mb-6">
                        <img src="/src/images/logo-desa.jpg" alt="Desa Kedungwungu"
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-sm text-emerald-600">Sewon, Bantul, Yogyakrta</p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="relative">
                            ...
                            <div class="flex items-center gap-2 mb-3">
                                ...
                                <div class="hidden sm:flex gap-1 text-xs text-gray-500">
                                    ...
                                    <span>Layanan Helpdesk UPA TIK</span>
                                </div>
                            </div>
                            ...
                            <p class="text-gray-600 mt-2 flex items-center">
                                ...
                                Masuk untuk mengakses Helpdesk Ticketing
                            </p>
                        </div>
                    </div>
                        ...
                        <div>
                            ...
                            <div class="relative" x-data="{ showPassword: false }">
                                ...
                                <input id="password"
                                    ...
                                    placeholder="••••••••" x-bind:type="showPassword ? 'text' : 'password'" />
                ...
                <div class="text-center mt-6">
                    <p class="text-sm text-gray-600">
                        Belum punya akun?
                        <a class="font-medium text-emerald-600 hover:text-emerald-700"
